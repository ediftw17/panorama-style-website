      ...
      <div className="relative z-10 text-center px-5 max-w-5xl mx-auto">
        ...
        <div className="animate-fade-in-up flex flex-col sm:flex-row items-center justify-center gap-3 mb-4" style={{ animationDelay: '800ms' }}>
          ...
          >
            ...
            <span className="text-[11px] font-normal opacity-70">{WA_PHONE_DISPLAY}</span>
          </a>
          <a
            href={waUrl(lang)}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex flex-col items-center justify-center gap-0.5 border border-white/25 text-white/75 px-8 py-3 hover:border-white/50 hover:text-white transition-all"
          >
            <span className="flex items-center gap-2 text-sm font-semibold tracking-wide">
            ...
            <span className="text-[11px] font-normal opacity-60">{WA_DISPLAY}</span>
          </a>
        </div>
