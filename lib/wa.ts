...
export const WA_PHONE_DISPLAY = '+972-50-800-5606'  // Phone number (displayed)
export const WA_PHONE_TEL = '+972508005606'          // Phone number (tel: link)
...
export const WAZE_URL = 'https://waze.com/ul?q=Panorama+Style+Haifa&navigate=yes'
