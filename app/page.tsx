            ...
            <div>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href={`tel:${t.contact.phone.replace(/[^+\d]/g, '')}`} className="text-white/55 hover:text-gold transition-colors font-sans text-sm" dir="ltr">
                    {t.contact.phone}
                  </a>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <a href="https://wa.me/972506461983" target="_blank" rel="noopener noreferrer" className="text-white/55 hover:text-gold transition-colors font-sans text-sm" dir="ltr">
                    {t.contact.whatsapp}
                  </a>
                </div>
              </div>
