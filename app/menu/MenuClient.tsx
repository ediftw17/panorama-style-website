    ...
    <div className="min-h-screen bg-background pt-24 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-6 sm:mb-12">
          ...
          <h1 className="font-playfair text-3xl sm:text-5xl md:text-6xl font-bold text-cream mt-2 mb-4">
            {t.title}
          </h1>
        ...
        <div className="space-y-4 sm:space-y-10">
          {t.categories.map((category, ci) => (
            <div key={ci}>
              ...
              <div className="p-0 sm:bg-darkcard sm:border sm:border-gold/10 sm:rounded-sm sm:p-6 md:p-8">
                <h2 className="font-playfair text-lg sm:text-2xl md:text-3xl font-bold text-gold mb-3 sm:mb-6">
                  {category.name}
                </h2>
        ...
        {/* Contact note */}
        <div className="mt-8 sm:mt-16 text-center bg-gold/5 border border-gold/20 rounded-sm p-5 sm:p-8">
